...
<head>
	...
	<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@10.16.6/dist/sweetalert2.min.css">
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<br>
					<h1>Recherche des Devis</h1>
					<br>
					<?php if (isset($liste_devis)) : ?>
