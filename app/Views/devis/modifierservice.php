        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <br>
                    <form method="post" action="<?= base_url('service/update/'.$service['id_service']) ?>">
                            ...
                            <div class="service">
                                <div class="row">
                                    <div class="mb-3 col-sm-7">
                                        ...
                                        <input type="text" class="form-control desc_0" id="desc" name="titre" value="<?= $service['titre']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-sm-7">
                                        <label for="desc" class="form-label">Description du service</label>
                                        <textarea class="form-control desc_0" id="desc" name="descriptif_devis" cols="30" rows="9"><?= $service['descriptif_devis'] ?: '' ?></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="mb-3 col-sm-2">
                                            <label for="pu" class="form-label">Prix Unitaire</label>
                                            <input type="text" class="form-control prices prix_0" id="pu" name="prix_unitaire" onInput="updateTotal(0)" value="<?= $service['prix_unitaire']; ?>">
                                        </div>
                                    </div>
                                </div>
