                                ...
                                <?php foreach ($result as $fact) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/deleteFacture/<?= $fact['id_client'] ?>"><span class="material-icons">delete</span></a>
                                            <a href="<?= base_url('#') ?>" class="show"><span class="material-icons material-icons-outlined">visibility</span></a>
